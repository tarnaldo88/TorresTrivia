...
const DEFAULT_TRIVIA_QUESTIONS = [
  ...
  // Science (15 additional questions)
  { id: 'trivia_76', question: 'What is the chemical symbol for iron?', answer: 'Fe', category: 'Science', difficulty: 'Easy' },
  { id: 'trivia_77', question: 'What is the smallest planet in our solar system?', answer: 'Mercury', category: 'Science', difficulty: 'Easy' },
  { id: 'trivia_78', question: 'What is the process by which plants make food?', answer: 'Photosynthesis', category: 'Science', difficulty: 'Easy' },
  { id: 'trivia_79', question: 'How many elements are in the periodic table?', answer: '118', category: 'Science', difficulty: 'Medium' },
  { id: 'trivia_80', question: 'What is the study of animals called?', answer: 'Zoology', category: 'Science', difficulty: 'Medium' },
  { id: 'trivia_81', question: 'What is the hardest natural substance on Earth?', answer: 'Diamond', category: 'Science', difficulty: 'Easy' },
  { id: 'trivia_82', question: 'How many sides does a snowflake typically have?', answer: '6', category: 'Science', difficulty: 'Medium' },
  { id: 'trivia_83', question: 'What is the chemical formula for table salt?', answer: 'NaCl', category: 'Science', difficulty: 'Medium' },
  { id: 'trivia_84', question: 'What is the study of plants called?', answer: 'Botany', category: 'Science', difficulty: 'Medium' },
  { id: 'trivia_85', question: 'How many strings does a violin have?', answer: '4', category: 'Science', difficulty: 'Easy' },
  { id: 'trivia_86', question: 'What is the freezing point of water in Celsius?', answer: '0', category: 'Science', difficulty: 'Easy' },
  { id: 'trivia_87', question: 'What is the study of the Earth called?', answer: 'Geology', category: 'Science', difficulty: 'Medium' },
  { id: 'trivia_88', question: 'How many sides does a hexagon have?', answer: '6', category: 'Science', difficulty: 'Easy' },
  { id: 'trivia_89', question: 'What is the chemical symbol for silver?', answer: 'Ag', category: 'Science', difficulty: 'Hard' },
  { id: 'trivia_90', question: 'What is the study of weather called?', answer: 'Meteorology', category: 'Science', difficulty: 'Medium' },

  // History (15 additional questions)
  { id: 'trivia_91', question: 'In what year did the moon landing occur?', answer: '1969', category: 'History', difficulty: 'Easy' },
  { id: 'trivia_92', question: 'Who was the first Emperor of Japan?', answer: 'Jimmu', category: 'History', difficulty: 'Hard' },
  { id: 'trivia_93', question: 'In what year did the Magna Carta get signed?', answer: '1215', category: 'History', difficulty: 'Hard' },
  { id: 'trivia_94', question: 'Who was the first President of India?', answer: 'Rajendra Prasad', category: 'History', difficulty: 'Hard' },
  { id: 'trivia_95', question: 'In what year did the Renaissance begin?', answer: '14th century', category: 'History', difficulty: 'Hard' },
  { id: 'trivia_96', question: 'Who was the first Prime Minister of India?', answer: 'Jawaharlal Nehru', category: 'History', difficulty: 'Medium' },
  { id: 'trivia_97', question: 'In what year did the Industrial Revolution begin?', answer: '1760', category: 'History', difficulty: 'Hard' },
  { id: 'trivia_98', question: 'Who was the first President of China?', answer: 'Mao Zedong', category: 'History', difficulty: 'Medium' },
  { id: 'trivia_99', question: 'In what year did World War I end?', answer: '1918', category: 'History', difficulty: 'Easy' },
  { id: 'trivia_100', question: 'Who was the first President of Mexico?', answer: 'Guadalupe Victoria', category: 'History', difficulty: 'Hard' },
  { id: 'trivia_101', question: 'In what year did the Cold War begin?', answer: '1947', category: 'History', difficulty: 'Medium' },
  { id: 'trivia_102', question: 'Who was the first President of Brazil?', answer: 'Deodoro da Fonseca', category: 'History', difficulty: 'Hard' },
  { id: 'trivia_103', question: 'In what year did the Vietnam War end?', answer: '1975', category: 'History', difficulty: 'Medium' },
  { id: 'trivia_104', question: 'Who was the first President of Russia?', answer: 'Boris Yeltsin', category: 'History', difficulty: 'Medium' },
  { id: 'trivia_105', question: 'In what year did the Korean War begin?', answer: '1950', category: 'History', difficulty: 'Medium' },

  // Geography (15 additional questions)
  { id: 'trivia_106', question: 'What is the capital of Germany?', answer: 'Berlin', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_107', question: 'What is the capital of Spain?', answer: 'Madrid', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_108', question: 'What is the capital of Italy?', answer: 'Rome', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_109', question: 'What is the capital of Mexico?', answer: 'Mexico City', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_110', question: 'What is the capital of South Korea?', answer: 'Seoul', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_111', question: 'What is the capital of Thailand?', answer: 'Bangkok', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_112', question: 'What is the capital of Greece?', answer: 'Athens', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_113', question: 'What is the capital of Portugal?', answer: 'Lisbon', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_114', question: 'What is the capital of Turkey?', answer: 'Ankara', category: 'Geography', difficulty: 'Medium' },
  { id: 'trivia_115', question: 'What is the capital of Poland?', answer: 'Warsaw', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_116', question: 'What is the capital of Sweden?', answer: 'Stockholm', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_117', question: 'What is the capital of Norway?', answer: 'Oslo', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_118', question: 'What is the capital of Denmark?', answer: 'Copenhagen', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_119', question: 'What is the capital of Netherlands?', answer: 'Amsterdam', category: 'Geography', difficulty: 'Easy' },
  { id: 'trivia_120', question: 'What is the capital of Belgium?', answer: 'Brussels', category: 'Geography', difficulty: 'Easy' },

  // Literature (15 additional questions)
  { id: 'trivia_121', question: 'Who wrote The Hobbit?', answer: 'J.R.R. Tolkien', category: 'Literature', difficulty: 'Easy' },
  { id: 'trivia_122', question: 'Who wrote Dracula?', answer: 'Bram Stoker', category: 'Literature', difficulty: 'Medium' },
  { id: 'trivia_123', question: 'Who wrote The Invisible Man?', answer: 'H.G. Wells', category: 'Literature', difficulty: 'Medium' },
  { id: 'trivia_124', question: 'Who wrote Alice in Wonderland?', answer: 'Lewis Carroll', category: 'Literature', difficulty: 'Easy' },
  { id: 'trivia_125', question: 'Who wrote The Time Machine?', answer: 'H.G. Wells', category: 'Literature', difficulty: 'Medium' },
  { id: 'trivia_126', question: 'Who wrote Treasure Island?', answer: 'Robert Louis Stevenson', category: 'Literature', difficulty: 'Medium' },
  { id: 'trivia_127', question: 'Who wrote The Strange Case of Dr. Jekyll and Mr. Hyde?', answer: 'Robert Louis Stevenson', category: 'Literature', difficulty: 'Medium' },
  { id: 'trivia_128', question: 'Who wrote Sense and Sensibility?', answer: 'Jane Austen', category: 'Literature', difficulty: 'Medium' },
  { id: 'trivia_129', question: 'Who wrote Emma?', answer: 'Jane Austen', category: 'Literature', difficulty: 'Medium' },
  { id: 'trivia_130', question: 'Who wrote The Scarlet Letter?', answer: 'Nathaniel Hawthorne', category: 'Literature', difficulty: 'Hard' },
  { id: 'trivia_131', question: 'Who wrote The Hunchback of Notre-Dame?', answer: 'Victor Hugo', category: 'Literature', difficulty: 'Medium' },
  { id: 'trivia_132', question: 'Who wrote Les Misérables?', answer: 'Victor Hugo', category: 'Literature', difficulty: 'Easy' },
  { id: 'trivia_133', question: 'Who wrote The Count of Monte Cristo?', answer: 'Alexandre Dumas', category: 'Literature', difficulty: 'Medium' },
  { id: 'trivia_134', question: 'Who wrote The Three Musketeers?', answer: 'Alexandre Dumas', category: 'Literature', difficulty: 'Easy' },
  { id: 'trivia_135', question: 'Who wrote Wuthering Heights?', answer: 'Emily Brontë', category: 'Literature', difficulty: 'Medium' },

  // Sports (15 additional questions)
  { id: 'trivia_136', question: 'How many players are on a cricket team on the field?', answer: '11', category: 'Sports', difficulty: 'Medium' },
  { id: 'trivia_137', question: 'What is the circumference of a basketball?', answer: '29.5 inches', category: 'Sports', difficulty: 'Hard' },
  { id: 'trivia_138', question: 'How many points is a field goal worth in American football?', answer: '3', category: 'Sports', difficulty: 'Easy' },
  { id: 'trivia_139', question: 'What is the length of a tennis court?', answer: '78 feet', category: 'Sports', difficulty: 'Hard' },
  { id: 'trivia_140', question: 'How many points is a free throw worth in basketball?', answer: '1', category: 'Sports', difficulty: 'Easy' },
  { id: 'trivia_141', question: 'What is the width of a soccer goal?', answer: '8 yards', category: 'Sports', difficulty: 'Hard' },
  { id: 'trivia_142', question: 'How many points is a goal worth in ice hockey?', answer: '1', category: 'Sports', difficulty: 'Easy' },
  { id: 'trivia_143', question: 'What is the length of a baseball bat?', answer: '42 inches', category: 'Sports', difficulty: 'Hard' },
  { id: 'trivia_144', question: 'How many points is a try worth in rugby?', answer: '5', category: 'Sports', difficulty: 'Medium' },
  { id: 'trivia_145', question: 'What is the height of a volleyball net?', answer: '7 feet 11 inches', category: 'Sports', difficulty: 'Hard' },
  { id: 'trivia_146', question: 'How many points is a basket worth in basketball?', answer: '2', category: 'Sports', difficulty: 'Easy' },
  { id: 'trivia_147', question: 'What is the length of a football field?', answer: '100 yards', category: 'Sports', difficulty: 'Easy' },
